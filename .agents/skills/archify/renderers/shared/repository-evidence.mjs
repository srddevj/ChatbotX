...
export function verifyRepositoryEvidence(diagramType, diagram, repoRootInput) {
  if (!hasRepositoryEvidence(diagramType, diagram)) {
    return null
  }
  if (diagramType !== "architecture") {
    evidenceFailure(
  ...
  if (!repository) {
    evidenceFailure(
      ...
      "Repository evidence requires /meta/repository.",
      {
        ...
        supportedFixes: [
          "add the pinned public repository metadata or remove component sources",
        ],
      },
    )
  }
  ...
  if (
    !(authoredSlug && String(repository.url).startsWith("https://github.com/"))
  ) {
    evidenceFailure(
      ...
      "/meta/repository/url must be a public https://github.com owner/repository URL.",
      {
        ...
        supportedFixes: [
          "use the canonical public GitHub HTTPS repository URL",
        ],
      },
    )
  }
